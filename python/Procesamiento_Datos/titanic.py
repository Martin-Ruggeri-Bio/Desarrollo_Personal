...
"""
Created on Sat Dec 19 11:10:05 2020
...
url_test = '/home/martin/Descargas/test.csv'
url_train = '/home/martin/Descargas/train.csv'

# Se leen y se guardan en variables
df_test = pd.read_csv(url_test)
df_train = pd.read_csv(url_train)

# Guardaremos los datos en un archivo en nuestra PC
dir_test = '/home/martin/Desarrollo_Personal/Procesamiento_Datos/titanic_test.csv'
dir_train = '/home/martin/Desarrollo_Personal/Procesamiento_Datos/titanic_train.csv'
...
#En X estaran las variables para contruir el modelo y en Y estara el resultado
X = np.array(df_train.drop(['Survived'], 1))
y = np.array(df_train['Survived'])

#Separo los datos de "train" en entrenamiento y prueba para probar los algoritmos
#Determinar la presicion del modelo implementado
